...
export function Ecosystem() {
  return (
    ...
    >
      <SectionHeader
        badge={{ icon: <Globe className="h-4 w-4" />, text: "Ecosystem" }}
        title={
          <>
            Part of the <GradientText>Stellar Ecosystem</GradientText>
          </>
        }
        description="Your agent leverages the full power of Stellar's network to move your money faster, cheaper, and smarter"
      />
